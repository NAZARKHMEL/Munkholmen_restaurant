...
class _OrdersPageState extends State<OrdersPage> {
  ...
  Future<void> fetchOrders() async {
    final response = await http.get(Uri.parse(
        'https://54b3-2001-4650-24fd-0-6c44-523a-ce6e-fbb6.ngrok-free.app/orders/${widget.roomId}')); // Подставляем roomId в URL
  ...
  Future<void> confirmOrder(int orderId) async {
    final response = await http.post(
      Uri.parse('https://54b3-2001-4650-24fd-0-6c44-523a-ce6e-fbb6.ngrok-free.app/confirm/$orderId'),
    );
